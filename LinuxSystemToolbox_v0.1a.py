...
class GlobalVars(object):
    lstver = "0.1a55 (Pre-Build Candidate)"
...
class NetToolbox():
    def Open():
        ...
        opt66enlbl = tk.Label(optionsfrm, text="Enabled")
        opt66enlbl.grid(column = 1, row = 1, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        opt66chk = tk.Checkbutton(optionsfrm)
        opt66chk.grid(column = 2, row = 1, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        opt66datalbl = tk.Label(optionsfrm, text="Data")
        opt66datalbl.grid(column = 3, row = 1, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        opt66data = tk.Entry(optionsfrm)
        opt66data.grid(column = 4, row = 1, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        ...
        opt67enlbl = tk.Label(optionsfrm, text="Enabled")
        opt67enlbl.grid(column = 1, row = 2, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        opt67chk = tk.Checkbutton(optionsfrm)
        opt67chk.grid(column = 2, row = 2, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        opt67datalbl = tk.Label(optionsfrm, text="Data")
        opt67datalbl.grid(column = 3, row = 2, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        opt67data = tk.Entry(optionsfrm)
        opt67data.grid(column = 4, row = 2, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        ...
        opt150enlbl = tk.Label(optionsfrm, text="Enabled")
        opt150enlbl.grid(column = 1, row = 3, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        opt150chk = tk.Checkbutton(optionsfrm)
        opt150chk.grid(column = 2, row = 3, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        opt150datalbl = tk.Label(optionsfrm, text="Data")
        opt150datalbl.grid(column = 3, row = 3, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
        opt150data = tk.Entry(optionsfrm)
        opt150data.grid(column = 4, row = 3, padx = GlobalVars.defpadx, pady = GlobalVars.defpady, sticky=GlobalVars.staticsticky)
