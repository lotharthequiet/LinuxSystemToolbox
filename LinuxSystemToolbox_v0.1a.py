...
class BuildGUI():
    ...
    cpucanvas.create_text(64, 30, text="_______", fill='#800000', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 35, text="_______", fill='#666600', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 40, text="_______", fill='#666600', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 45, text="_______", fill='#1a6600', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 50, text="_______", fill='#1a6600', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 55, text="_______", fill='#1a6600', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 60, text="_______", fill='#1a6600', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 65, text="_______", fill='#1a6600', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 70, text="_______", fill='#1a6600', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 75, text="_______", fill='#1a6600', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 80, text="_______", fill='#66ff33', font=('Cantarell Regular', 12, 'bold'))
    cpucanvas.create_text(64, 110, text="4%", fill='#66ff33', font=('Cantarell Regular', 14))
