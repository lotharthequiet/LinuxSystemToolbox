...
class GlobalVars(object):
    LSTVER = "0.1a20"                                                                       #Sytem Version number
...
class BuildGUI():
    ...
    cpucanvas.create_text(68, 40, text="____ ____", fill='#800000')
    cpucanvas.create_text(68, 45, text="____ ____", fill='#666600')
    cpucanvas.create_text(68, 50, text="____ ____", fill='#666600')
    cpucanvas.create_text(68, 55, text="____ ____", fill='#1a6600')
    cpucanvas.create_text(68, 60, text="____ ____", fill='#1a6600')
    cpucanvas.create_text(68, 65, text="____ ____", fill='#1a6600')
    cpucanvas.create_text(68, 70, text="____ ____", fill='#1a6600')
    cpucanvas.create_text(68, 75, text="____ ____", fill='#1a6600')
    cpucanvas.create_text(68, 80, text="____ ____", fill='#1a6600')
    cpucanvas.create_text(68, 85, text="____ ____", fill='#1a6600')
    cpucanvas.create_text(68, 90, text="____ ____", fill='#66ff33')
    cpucanvas.create_text(68, 115, text="4%", fill='#66ff33')
    #cpucanvas.create_image(128, 192)
    ...
    memcanvas.create_text(68, 40, text="____ ____", fill='#800000')
    memcanvas.create_text(68, 45, text="____ ____", fill='#666600')
    memcanvas.create_text(68, 50, text="____ ____", fill='#666600')
    memcanvas.create_text(68, 55, text="____ ____", fill='#1a6600')
    memcanvas.create_text(68, 60, text="____ ____", fill='#1a6600')
    memcanvas.create_text(68, 65, text="____ ____", fill='#1a6600')
    memcanvas.create_text(68, 70, text="____ ____", fill='#1a6600')
    memcanvas.create_text(68, 75, text="____ ____", fill='#1a6600')
    memcanvas.create_text(68, 80, text="____ ____", fill='#1a6600')
    memcanvas.create_text(68, 85, text="____ ____", fill='#66ff33')
    memcanvas.create_text(68, 90, text="____ ____", fill='#66ff33')
    memcanvas.create_text(68, 115, text="27140K", fill='#66ff33')
    ...
    #memhistcanvas.create_image(128, 192)
